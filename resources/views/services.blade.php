...
<div id="nav-wrapper" class="fixed top-0 inset-x-0 z-[90] flex justify-center px-4 md:px-6 pt-4 sm:pt-6 md:pt-8 transition-all duration-500 pointer-events-none">
    <nav id="main-nav" class="pointer-events-auto flex justify-between items-start md:items-start w-full max-w-full px-4 py-2 transition-all duration-[600ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] rounded-full border border-transparent">
        ...
        <div id="nav-menu" class="hidden md:flex flex-1 justify-center items-center gap-2 lg:gap-4 text-sm md:text-base font-bold tracking-wide -mt-2 transition-all duration-500">
            ...
            <a href="{{ route('services') }}" class= "menu-link px-4 py-2 rounded-full text-[#C89B5F] bg-[#EADCC8]/30 transition-all duration-300">Services</a>
...
<div id="mobile-menu-wrapper" class="fixed inset-0 z-[100] flex justify-end opacity-0 pointer-events-none transition-opacity duration-500">
    ...
    <div id="mobile-menu-panel" class="relative w-[80%] max-w-sm h-full bg-white shadow-[-20px_0_40px_rgba(0,0,0,0.15)] flex flex-col pt-10 px-8 transform translate-x-full transition-transform duration-[600ms] ease-[cubic-bezier(0.25,1,0.5,1)] rounded-l-[2rem] overflow-hidden">
        ...
        <div class="flex flex-col gap-1 mt-4">
            ...
            <a href="{{ route('services') }}" class="mobile-link group relative flex items-center text-[#C89B5F] font-Inter text-l tracking-[0.15em] uppercase py-4 transition-all duration-300">
    ...
    <section class="w-full px-4 md:px-6 text-center relative pt-[160px] md:pt-[200px] pb-20 md:pb-24 overflow-hidden" style="background: linear-gradient(135deg, #FDF8F3 0%, #E5CAA4 40%, #D9B78A 100%); border-bottom: 1px solid rgba(212, 184, 149, 0.5);">
        ...
        <div class="max-w-3xl mx-auto relative z-10 flex flex-col items-center">
            <div class="flex items-center gap-4 mb-5">
                ...
                <span class="text-[#1A120B]/80 text-[0.65rem] sm:text-xs font-bold tracking-[0.3em] uppercase">Premium Offerings</span>
                <span class="w-8 md:w-12 h-[1px] bg-[#1A120B]/30"></span>
            </div>
            ...
            <h1 class="text-4xl sm:text-5xl md:text-[4.5rem] text-[#1A120B] leading-[1.1] mb-6 md:mb-8 tracking-tight font-extrabold font-sans drop-shadow-sm uppercase reveal-left">
                OUR <span class="font-serif italic font-light capitalize text-gray-800 tracking-normal ml-1">Services</span>
            </h1>
            
            <p class="text-gray-800 text-[0.95rem] md:text-[1.1rem] leading-[2.2] font-light max-w-2xl mx-auto px-2 reveal-right">
                Discover how we can elevate your events. From personalized laser engravings to professional on-site coconut service, we provide <strong class="font-medium text-[#1A120B]">unforgettable tropical experiences.</strong>
            </p>
        </div>
    </section>

    {{-- ░░ ZIG-ZAG SERVICES SECTION ░░ --}}
    <section class="w-full py-16 md:py-24 px-5 md:px-12 bg-white overflow-hidden">
        <div class="max-w-6xl mx-auto flex flex-col gap-24 md:gap-32">

        {{-- Service 1: Custom Logo (Gambar Kiri, Teks Kanan) --}}
            <div class="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-[#1A120B] uppercase tracking-tight mb-4 text-center lg:text-left">Custom Coconut <span class="text-[#C89B5F]">Logo</span></h2>
                <p class="text-gray-600 leading-relaxed mb-6 font-light text-justify lg:text-left">Any great event needs a detail, guests won't forget. Our precision laser engraved adds a personalized branded touch to your fresh coconuts, whether it's your wedding monogram, business logo or custom engraved art. A tasteful edible centerpiece that embodyes natural beauty with your personal narrative; an impressive lasting impression well beyond the last sip.</p>
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> High-precision laser engraving for sharp, detailed results
                        </li>
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Safe & food-grade preparation on every coconut
                        </li>
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> On-time delivery straight to your venue
                        </li>
                    </ul>

                    <a href="https://wa.me/6282146445465" target="_blank" class="flex w-fit mx-auto lg:mx-0 items-center gap-2 bg-[#1A120B] text-white px-8 py-3 rounded-full text-sm font-bold uppercase tracking-widest hover:bg-[#C89B5F] hover:shadow-lg transition-all duration-300">
                    Order Now <i class="fab fa-whatsapp text-lg"></i>
                    </a>
                </div>
            </div>

            {{-- Service 2: Staff In-Charge (Teks Kiri, Gambar Kanan) --}}
            {{-- Menggunakan lg:flex-row-reverse untuk membalik posisi --}}
            <div class="flex flex-col lg:flex-row-reverse items-center gap-10 md:gap-16">
                ...
                {{-- Teks (Animasi dari Kiri) --}}
                <div class="w-full lg:w-1/2 reveal-left">
                <h2 class="text-3xl md:text-4xl font-extrabold text-[#1A120B] uppercase tracking-tight mb-4 text-center lg:text-left">Professional <span class="text-[#C89B5F]">Staff In-Charge</span></h2>
                <p class="text-gray-600 leading-relaxed mb-6 font-light text-justify lg:text-left">Leave the serving to us. Our friendly, professional team is there to make sure everything runs smoothly from start to finish. Whether it’s opening fresh coconuts right in front of your guests or serving with a warm smile, we pay attention to every detail. More than just serving drinks, we help create a fun and memorable experience that adds a special touch to your event, allowing you to relax and enjoy the occasion with your guests.
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Experienced & presentable staff in branded uniform
                        </li>
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Live coconut opening as a wow-factor experience
                        </li>
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Full setup & clean-up — zero hassle, start to finish
                        </li>
                    </ul>

                    <a href="https://wa.me/6282146445465" target="_blank" class="flex w-fit mx-auto lg:mx-0 items-center gap-2 bg-[#1A120B] text-white px-8 py-3 rounded-full text-sm font-bold uppercase tracking-widest hover:bg-[#C89B5F] hover:shadow-lg transition-all duration-300">Book Our Staff <i class="fab fa-whatsapp text-lg"></i>
                    </a>
                </div>
            </div>

            {{-- Service 3: Resort Supply (Gambar Kiri, Teks Kanan) --}}
            <div class="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
                {{-- Gambar (Animasi dari Kiri) --}}
                <div class="w-full lg:w-1/2 reveal-left">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl group">
                ...
                {{-- Teks (Animasi dari Kanan) --}}
                <div class="w-full lg:w-1/2 reveal-right">
                <h2 class="text-3xl md:text-4xl font-extrabold text-[#1A120B] uppercase tracking-tight mb-4 text-center lg:text-left">Resort & Hotel <span class="text-[#C89B5F]">Supply</span></h2>
                <p class="text-gray-600 leading-relaxed mb-6 font-light text-justify lg:text-left">A memorable guest experience begins with thoughtful details. We supply premium-quality coconuts that are carefully selected for their freshness, sweetness, and presentation. With reliable deliveries tailored to your schedule, you can serve a refreshing welcome drink that complements the standards of your property. From boutique villas to luxury resorts, we help elevate the arrival experience with a touch of authentic tropical hospitality.
                </p>
                    
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Hand-selected for consistent taste & premium quality
                        </li>
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Reliable delivery schedule tailored to your operations
                        </li>
                        <li class="flex items-center text-sm font-medium text-gray-700">
                            <i class="fas fa-check-circle text-[#C89B5F] mr-3 text-lg"></i> Flexible bulk pricing for long-term partnerships
                        </li>
                    </ul>

                    <a href="https://wa.me/6282146445465" target="_blank" class="flex w-fit mx-auto lg:mx-0 items-center gap-2 bg-[#1A120B] text-white px-8 py-3 rounded-full text-sm font-bold uppercase tracking-widest hover:bg-[#C89B5F] hover:shadow-lg transition-all duration-300">Get a Quote <i class="fab fa-whatsapp text-lg"></i>
                    </a>
                </div>
            </div>
