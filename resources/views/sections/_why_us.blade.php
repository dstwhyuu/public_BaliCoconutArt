{{-- ═══════════════════════════════════════════════════════════════
    SECTION: WHY CHOOSE US (#why-us)
    Layout  : Stacking Cards on Scroll
    Theme   : Pure White to Subtle Tropical Greens
═══════════════════════════════════════════════════════════════ --}}

<section id="why-us" class="relative bg-white pt-8 pb-4 px-4 md:px-6 lg:px-12 overflow-visible">    
    <div class="max-w-6xl mx-auto relative">
        
    {{-- Header Section --}}
        <div class="text-center mb-12 md:mb-16 relative z-0">
            <div class="flex items-center justify-center gap-4 mb-3">
                <span class="text-[#8CC63F] text-xs font-bold tracking-[0.2em] uppercase">Why Choose Us</span>
            </div>
            
            <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 uppercase leading-tight mb-4">
                WHY CUSTOM
                <span class="text-[#8CC63F]">COCONUTS?</span>
            </h2>
        ...
        <div class="relative w-full pb-20 md:pb-32">
            ...
            {{-- KARTU 2: Ultra-light Tropical Green --}}
            <div class="sticky top-32 md:top-40 z-20 w-full bg-[#FAFCF7] rounded-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-[#EBF2E4] flex flex-col md:flex-row-reverse h-auto md:h-[480px] mb-12 md:mb-16 transition-all duration-500 p-3 md:p-5">
                <div class="w-full md:w-1/2 h-[220px] sm:h-64 md:h-full shrink-0">
            ...
            {{-- KARTU 3: Soft Tropical Green --}}
            <div class="sticky top-40 md:top-48 z-30 w-full bg-[#F2F8EC] rounded-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-[#DCE8D0] flex flex-col md:flex-row h-auto md:h-[480px] transition-all duration-500 p-3 md:p-5">
                <div class="w-full md:w-1/2 h-[220px] sm:h-64 md:h-full shrink-0">
                    <img src="{{ asset('images/n8.webp') }}" alt="Eco-Friendly Souvenir" class="w-full h-full object-cover rounded-3xl">
                </div>
                <div class="w-full md:w-1/2 p-6 sm:p-8 md:px-12 flex flex-col justify-center text-center md:text-left">
                    <h3 class="text-3xl md:text-5xl font-serif text-gray-900 leading-tight mb-4 md:mb-6">
                    ZERO-WASTE <br>
